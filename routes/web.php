...
//Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::get('/categories', [CategoryController::class, 'index'])->name('category.index'); //notice the endpoint `/inventory` can easily change but the real deal url is `product.index` that will be used in frontend.
